...
// Use deployed backend URL in production (replace with your backend URL)
const BASE =
  process.env.NODE_ENV === "production"
    ? "https://health-b.onrender.com/api"
    : "/api";
...
export const updateTreatment = (id, data) =>
  API.put(`/appointments/${id}/treatment`, data);
...
export const fetchDoctors = (specialization) =>
  API.get(`/users/doctors?specialization=${specialization}`);
